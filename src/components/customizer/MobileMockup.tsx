  ...
  return (
    <div className="h-full bg-gradient-to-br from-gray-100 via-gray-50 to-blue-50 flex items-center justify-center p-1">
      ...
      <div className="relative">
        {/* Ombra del telefono */}
        <div className="absolute inset-0 bg-black/15 rounded-[18px] transform translate-y-1 translate-x-0.5 blur-sm scale-105"></div>
        
        {/* Frame del telefono - Ridotto ulteriormente */}
        <div className="relative w-[240px] h-[480px] bg-gradient-to-b from-gray-800 via-gray-900 to-black rounded-[18px] p-[6px] shadow-xl hover:scale-105 transition-transform duration-300">
          ...
          <div className="w-full h-full bg-black rounded-[14px] overflow-hidden relative">
            ...
            {/* Safari Browser UI */}
            <div className="absolute top-[26px] left-0 right-0 bg-gray-50 px-2 py-0.5 flex items-center gap-1 border-b border-gray-200 z-30">
            ...
            {/* Website Content - Compatto */}
            <div className="absolute top-[44px] left-0 right-0 bottom-[20px] overflow-hidden">
          ...
          <div className="absolute inset-[6px] rounded-[14px] bg-gradient-to-tr from-transparent via-white/5 to-transparent pointer-events-none"></div>
        </div>

        {/* Volume buttons - Ridimensionati */}
        <div className="absolute left-[-1.5px] top-[80px] w-[1.5px] h-[20px] bg-gray-700 rounded-l-sm"></div>
        <div className="absolute left-[-1.5px] top-[110px] w-[1.5px] h-[20px] bg-gray-700 rounded-l-sm"></div>
        
        {/* Power button - Ridimensionato */}
        <div className="absolute right-[-1.5px] top-[95px] w-[1.5px] h-[20px] bg-gray-700 rounded-r-sm"></div>
      </div>
    </div>
  );
};
